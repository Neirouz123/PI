...
class Reservation
{
    ...
    #[Assert\Type(type: '\DateTimeInterface', message: 'Invalid time format')]
    ...
    #[Assert\Type(type: 'bool', message: 'Confirmation status must be true or false')]
    ...
    #[Assert\NotNull(message: 'Please select a venue')]
